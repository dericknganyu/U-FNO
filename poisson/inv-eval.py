...
####TO EDITcompare_inv_513~res_0.025409~RelL2TestError_1000~ntrain_5000~ntest_5~BatchSize_0.001~LR_0.0001~Reg_0.5~gamma_100~Step_500~epochs_
if res == 513:
    test_l2 = 0.025409#0.007091
    timestamp = '20220806-160519'
    batch_size = 5
if res == 257:
    test_l2 = 0.008061
...
plt.savefig("figures/inv/1Error_VS_TrainingStep"+ModelInfos+".png", dpi=500)
...
fig.tight_layout()
plt.savefig('figures/inv/U-FNO-Poisson-Forward-UG.png',dpi=500)