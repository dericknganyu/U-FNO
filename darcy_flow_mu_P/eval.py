...
if res == 513:
    test_l2 = 0.009456
    timestamp = '20220725-023609'
    batch_size = 5
if res == 257:
    test_l2 = 0.007431
    timestamp = '20220723-151817'
if res == 129:
    test_l2 = 0.007091
    timestamp = '20220723-070406'
if res == 65:
    test_l2 = 0.007763
    timestamp = '0.007763'
if res == 33:
    test_l2 = 0.014182
    timestamp = '20220723-002449'
if res == 17:
    test_l2 = 0.028659
    timestamp = '20220723-003010'
...
plt.savefig("figures/1Error_VS_TrainingStep"+ModelInfos+".png", dpi=500)
...
fig.tight_layout()
plt.savefig('figures/UFNO-Darcy-Forward-UP.png',dpi=500)
