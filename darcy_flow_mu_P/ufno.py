...
for ep in range(epochs):
    ...
    file = open('files/lossTrainData_'+TIMESTAMP+'.txt',"a")
    file.write(str(ep)+" "+str(train_l2)+"\n")#file.write(str(ep)+" "+str(train_mse)+"\n")
    file = open('files/lossTestData_'+TIMESTAMP+'.txt',"a")
...
os.rename('files/lossTrainData_'+TIMESTAMP+'.txt', 'files/lossTrainData'+ModelInfos+'.txt')
os.rename('files/lossTestData_'+TIMESTAMP+'.txt', 'files/lossTestData'+ModelInfos+'.txt')

dataTrain = np.loadtxt('files/lossTrainData'+ModelInfos+'.txt')
dataTest  = np.loadtxt('files/lossTestData'+ModelInfos+'.txt')
