...
if res == 513:
	test_l2 = 0.008514
	timestamp = '20220725-022051'
	batch_size = 5
if res == 257:
	test_l2 = 0.032216
	timestamp = '20220723-145503'
if res == 129:
	test_l2 = 0.063977
	timestamp = '20220723-065937'
if res == 65:
	test_l2 = 0.092811
	timestamp = '0.092811'
if res == 33:
	test_l2 = 0.137033
	timestamp = '20220723-002942'
if res == 17:
	test_l2 = 0.187207
...
fig.tight_layout()
plt.savefig('figures/inv/UFNO-Darcy-Inverse-UP.png',dpi=500)
